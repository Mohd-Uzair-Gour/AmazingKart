...
const HeaderComponent = () => {
  ...
  useEffect(() => {
    if (userInfo && userInfo.isAdmin) {  // Check if userInfo exists before accessing isAdmin
  ...
  }, [userInfo]);  // Add userInfo as a dependency for useEffect

  return (
    <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
      <Container>
        <LinkContainer to="/">
          <Navbar.Brand href="/">AmazingKart</Navbar.Brand>
        </LinkContainer>
